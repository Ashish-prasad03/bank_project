...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        JLabel pnumber = new JLabel("XXXXX");
        pnumber.setFont(new Font("Raleway", Font.BOLD, 22));
        pnumber.setBounds(330, 370, 300, 30);
        add(pnumber);

        JLabel pindetails = new JLabel("Your 5 Digit Password :");
        ...
        c7 = new JCheckBox("I Hereby Declaires that the above entered details are Corrected");
