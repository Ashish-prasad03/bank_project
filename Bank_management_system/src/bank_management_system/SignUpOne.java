...
public class SignUpOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameTextField, fnameTextField, cityTextField, emailTextField, stateTextField,pinTextField, addressTextField;
    JButton next;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                conn c = new conn();
                String query = "insert into signup values('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+state+"', '"+pin+"', '"+city+"')";
